...
export class Mirai {
   ...
   */
  postVerify(data: PickMariaReq<typeof verifyApi.POST_VERIFY_API>) {
   ...
   */
  postBind(data: PickMariaReq<typeof verifyApi.POST_BIND_API>) {
   ...
   */
  getSessionInfo(data: PickMariaReq<typeof verifyApi.GET_SESSION_INFO_API>) {
   ...
   */
  getMemberList(params: PickMariaReq<typeof infoApi.GET_MEMBER_LIST_API>) {
   ...
   */
  sendFriendMessage(
    data: PickMariaReq<typeof messageApi.POST_SEND_FRIEND_MESSAGE_API>
  ) {
   ...
   */
  sendGroupMessage(
    data: PickMariaReq<typeof messageApi.POST_SEND_GROUP_MESSAGE_API>
  ) {
