...
export declare type IMessageChain = IPlanMessage | ISourceMessage | IFaceMessage | IImageMessage | IAtAllMessage | IAtMessage | IQuoteMessage;
...
export declare type IMiraiMessage = IFriendMessage | IGroupMessage;
